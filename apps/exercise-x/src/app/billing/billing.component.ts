...
export class BillingComponent {
  ...
  selectedContract: Observable<SupplyContract | undefined> = this.#stateService.select((state) => state.contract);

  contracts$ = this.#contractsService.getContracts();
  value = undefined;
  selectedValue: SupplyContract | undefined;

  setContract(contract: SupplyContract | undefined) {
